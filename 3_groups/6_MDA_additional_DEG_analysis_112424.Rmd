...
marker <- FindMarkers(temp.obj,
      ...
      assign(paste("P21",br,"NOTdeg",sep = "."), marker)
...
#Edit as needed for each trend
    ...
    csv_filename <- "Hippocampus_EGO_trend1_reduced.csv"
    write.csv(hippo_trend3_ego_result, file = csv_filename, row.names = FALSE)
